...
(Acute means short-term. Chronic means long-lasting.)
...
(These are the main drug groups used to lower inflammation.)
...
(These are the common ways dead tissue is removed.)
...
(This section explains how infection starts, spreads, and is prevented.)
...
(This section is about breathing, lung care, and how the body gets oxygen.)
...
- Usually caused by mucus or secretions in the larger airways.

#### Wheezing

- Usually caused by narrowed or tightened airways.
...
### Identify complications associated with hyperventilation, hypoventilation, and hypoxia
...
- Dysrhythmias
- Organ damage
- Cardiac arrest if severe and untreated
...
- Pulmonary edema in selected patients
- Hypercapnic respiratory failure when the patient can still protect the airway
...
(This is the path blood follows through the heart and lungs.)
...
(This section explains how pain is assessed and treated.)
...
- Helpful for children or patients who have trouble using numbers.

#### Passero Opioid-Induced Sedation Scale

- Used to check sedation level and opioid safety.

### Identify three categories of analgesic drug therapy
...
(This section is about body water, body salts, and fluid balance.)
...
(Fluid volume deficit means the body does not have enough fluid.)
...
(Fluid volume excess means the body is holding too much fluid.)
